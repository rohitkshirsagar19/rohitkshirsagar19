...
<p align="center">
  ...
  <a href="https://rohitkshirsagar19.github.io/"><img src="https://img.shields.io/badge/Portfolio-Website-ff69b4?style=for-the-badge&logo=codeigniter&logoColor=white" alt="Portfolio"></a>
</p>
...
*(June 2025 – Sept 2025)*
- **Production NLP:** Developed a multilingual pipeline (Hinglish) using fine-tuned **Qwen-3 32B**, achieving **95% classification accuracy**.
- **Automation:** Built an LLM-powered transcript-to-JSON tool, reducing manual review time by **80%**.
- **Stack:** Python, vLLM, Quantization, Docker.

### **Python Developer | MEGAMINDS IT Services**
*(July 2024 – Sept 2024)*
- **Optimization:** Implemented algorithms from 5+ research papers, improving data processing speed and model accuracy by **15%**.
- **Delivery:** Collaborated with the R&D team to ship 3 client projects on strict deadlines.

---

## 💻 Featured Projects

### 1. Fault-Tolerant Custom Load Balancer (Go)
*> A high-performance Layer 7 Load Balancer built from scratch.*
- **Core Tech:** **Golang**, **Concurrency (Goroutines)**, **Mutex Locks**, **Round-Robin**.
- **Engineering:** Implemented active health checks and thread-safe request routing. Handles high concurrency without race conditions.
- **Why it matters:** Demonstrates deep understanding of distributed systems and low-level backend logic.

### 2. DevBoss: Autonomous AI IT Manager
*> Multi-Agent System that automates the SDLC.*
